...
*   **Scope:** Service Provider 
*   **Service Type:** All
*   Documented policies are in place for protecting sensitive operations against misuse or unauthorized execution, and mechanisms are in place to enforce these policies.
